...
主页：\ `http://topex.ucsd.edu/WWW\_html/srtm30\_plus.html`_
...
-  两极地区的数据来自于\ `International Bathymetric Chart of the
   Oceans`_\ 。

.. _`http://topex.ucsd.edu/WWW\_html/srtm30\_plus.html`: http://topex.ucsd.edu/WWW_html/srtm30_plus.html
